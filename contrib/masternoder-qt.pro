...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/masternoder-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/masternoder-cli.cpp \
           src/masternoder-tx.cpp \
           src/masternoder.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/masternoder.qrc src/qt/masternoder_locale.qrc

TRANSLATIONS += src/qt/locale/masternoder_bg.ts \
                src/qt/locale/masternoder_de.ts \
                src/qt/locale/masternoder_en.ts \
                src/qt/locale/masternoder_es.ts \
                src/qt/locale/masternoder_fi.ts \
                src/qt/locale/masternoder_fr.ts \
                src/qt/locale/masternoder_it.ts \
                src/qt/locale/masternoder_ja.ts \
                src/qt/locale/masternoder_pl.ts \
                src/qt/locale/masternoder_pt.ts \
                src/qt/locale/masternoder_ru.ts \
                src/qt/locale/masternoder_sk.ts \
                src/qt/locale/masternoder_sv.ts \
                src/qt/locale/masternoder_vi.ts \
                src/qt/locale/masternoder_zh_CN.ts \
                src/qt/locale/masternoder_zh_TW.ts
