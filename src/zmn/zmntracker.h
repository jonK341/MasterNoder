...
#ifndef MasterNoder_ZMNTRACKER_H
#define MasterNoder_ZMNTRACKER_H
...
public:
    CzMNTracker(std::string strWalletFile);
    ~CzMNTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzMNWallet* zMNWallet = NULL);
...
#endif //MasterNoder_ZMNTRACKER_H
