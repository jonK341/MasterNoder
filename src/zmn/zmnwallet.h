...
#ifndef MasterNoder_ZMNWALLET_H
#define MasterNoder_ZMNWALLET_H
...
public:
    CzMNWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZMN(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZMN(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
