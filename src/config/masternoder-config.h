/* src/config/masternoder-config.h.  Generated from masternoder-config.h.in by configure.  */
/* src/config/masternoder-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.masternoder.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "MasterNoder Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "MasterNoder Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "masternoder"
