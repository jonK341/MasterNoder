...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop MasterNoder server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "MasterNoder server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* MasterNoder features */
        {"masternoder", "listmasternodes", &listmasternodes, true, true, false},
        {"masternoder", "getmasternodecount", &getmasternodecount, true, true, false},
        {"masternoder", "masternodeconnect", &masternodeconnect, true, true, false},
        {"masternoder", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"masternoder", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"masternoder", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"masternoder", "masternodecurrent", &masternodecurrent, true, true, false},
        {"masternoder", "masternodedebug", &masternodedebug, true, true, false},
        {"masternoder", "startmasternode", &startmasternode, true, true, false},
        {"masternoder", "createmasternodekey", &createmasternodekey, true, true, false},
        {"masternoder", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"masternoder", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"masternoder", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"masternoder", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"masternoder", "getmasternodescores", &getmasternodescores, true, true, false},
        {"masternoder", "preparebudget", &preparebudget, true, true, false},
        {"masternoder", "submitbudget", &submitbudget, true, true, false},
        {"masternoder", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"masternoder", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"masternoder", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"masternoder", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"masternoder", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"masternoder", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"masternoder", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"masternoder", "checkbudgets", &checkbudgets, true, true, false},
        {"masternoder", "mnsync", &mnsync, true, true, false},
        {"masternoder", "spork", &spork, true, true, false},
        {"masternoder", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzmnseed", &getzmnseed, false, false, true},
        {"zerocoin", "setzmnseed", &setzmnseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzmn", &searchdzmn, false, false, true},
        {"zerocoin", "dzmnstate", &dzmnstate, false, false, true},
...
{
    return "> masternoder-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:26621/\n";
}
