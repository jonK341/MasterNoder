...
/* MasterNoder GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "MasterNoder"
#define QAPP_ORG_DOMAIN "masternoder.org"
#define QAPP_APP_NAME_DEFAULT "MasterNoder-Qt"
#define QAPP_APP_NAME_TESTNET "MasterNoder-Qt-testnet"
