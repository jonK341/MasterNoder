...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("MasterNoder Core"),
     ...
     * override -datadir in the masternoder.conf file in the default data directory
     * (to be consistent with masternoderd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
