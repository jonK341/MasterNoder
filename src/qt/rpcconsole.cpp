                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzMNPathCustom = GetArg("-zmnbackuppath", "");
    ...
    if(!strzMNPathCustom.empty()) {
        ui->wallet_customzmnbackuppath->setText(QString::fromStdString(strzMNPathCustom));
        ui->wallet_customzmnbackuppath_label->setVisible(true);
        ui->wallet_customzmnbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzMNPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the MasterNoder RPC console.") + "<br>" +
