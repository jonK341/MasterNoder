...
/** Utility functions used by the MasterNoder Qt UI.
 */
namespace GUIUtil
{
...
// Render MasterNoder addresses in monospace font
...
// Parse "masternoder:" URI into recipient object, return true on successful parsing
