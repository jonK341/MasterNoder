...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::MN);
...
// Wallet
    ...
    if (settings.contains("nAnonymizeMasterNoderAmount"))
        SoftSetArg("-anonymizemasternoderamount", settings.value("nAnonymizeMasterNoderAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in masternoder.cpp during shotdown to also remove the window positions
