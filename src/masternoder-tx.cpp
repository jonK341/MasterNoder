...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("MasterNoder Core masternoder-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  masternoder-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded masternoder transaction") + "\n" +
                               "  masternoder-tx [options] -create [commands]   " + _("Create hex-encoded masternoder transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded masternoder transaction
