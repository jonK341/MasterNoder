...
from fake_stake.base_test import MasterNoder_FakeStakeTest

class zMNwrappedSerialsTest(MasterNoder_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zMNs..." % DENOM_TO_USE)
